 ...
 * 
 * Muestra una galería de productos categorizados según la ruta seleccionada.
 * El usuario puede visualizar las opciones disponibles por categoría y,
 * si está autenticado, puede agregar productos al carrito.
 * 
 * Funcionalidades:
 * - Detecta la categoría seleccionada mediante la URL.
 * - Muestra productos de la categoría correspondiente.
 * - Permite agregar productos al carrito si el usuario ha iniciado sesión.
 * 
 * Este componente se utiliza en la navegación principal del sitio cuando se accede a:
 * /categoria/:nombre (por ejemplo: /categoria/tortas)
 */
...
export class Categoria implements OnInit {
  ...
  /**
   * Base de datos local con los productos clasificados por categoría.
   * Se accede en tiempo de ejecución para simular una carga desde backend.
   */
  private datos = [
    {
   ...
   * @param item Objeto del producto a agregar.
   */
